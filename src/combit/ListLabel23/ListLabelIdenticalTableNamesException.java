...
import jio.System.Runtime.InteropServices.*;public class ListLabelIdenticalTableNamesException extends ListLabelException implements ISerializable,_Exception {protected NObject javonetHandle; /**
	 * GetProperty
	 */
            public java.lang.String getTableName (){ try { return  (java.lang.String) javonetHandle.get("TableName");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }public ListLabelIdenticalTableNamesException (java.lang.String tableName){  super((NObject) null); try {  javonetHandle = Javonet.New("ListLabelIdenticalTableNamesException",tableName); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ListLabelIdenticalTableNamesException(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
