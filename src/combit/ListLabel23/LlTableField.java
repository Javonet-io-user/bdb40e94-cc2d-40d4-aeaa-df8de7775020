...
import combit.ListLabel23.*;public class LlTableField extends ValueType {protected NObject javonetHandle; /**
	 * GetFiled
	 */
	 ...
	 * GetFiled
	 */
            public java.lang.Integer getnIndex (){ try { return javonetHandle.get("nIndex");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return 0;} }/**
	 * SetFiled
	 */
            public void setnIndex (java.lang.Integer param){ try { javonetHandle.set("nIndex",param);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }/**
	 * GetFiled
	 */
	 ...
	 * SetFiled
	 */
            public void setrcSpacing (RECT param){ try { javonetHandle.set("rcSpacing",param);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }/**
	 * GetFiled
	 */
	 ...
	 * SetFiled
	 */
            public void setpszContents (java.lang.String param){ try { javonetHandle.set("pszContents",param);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public LlTableField(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
