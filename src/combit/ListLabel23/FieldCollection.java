...
import jio.System.Collections.*;public class FieldCollection extends ElementBaseCollection implements IDictionary {protected NObject javonetHandle; public FieldCollection (ListLabel ll){  super((NObject) null); try {  javonetHandle = Javonet.New("FieldCollection",ll); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public FieldCollection(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
