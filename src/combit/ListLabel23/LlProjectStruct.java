...
import combit.ListLabel23.*;public class LlProjectStruct extends ValueType {protected NObject javonetHandle; /**
	 * GetFiled
	 */
	 ...
	 * SetFiled
	 */
            public void setrcPaint (RECT param){ try { javonetHandle.set("rcPaint",param);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public LlProjectStruct(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
