...
import jio.System.*;public class AutoRepositoryImportHandler implements IDisposable {protected NObject javonetHandle; public AutoRepositoryImportHandler (ListLabel ll,LlProjectLoadType expectedLoadType,java.lang.String projectFile,java.lang.String tempDir){ try {  javonetHandle = Javonet.New("AutoRepositoryImportHandler",ll,NEnum.fromJavaEnum(expectedLoadType),projectFile,tempDir);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public AutoRepositoryImportHandler(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
