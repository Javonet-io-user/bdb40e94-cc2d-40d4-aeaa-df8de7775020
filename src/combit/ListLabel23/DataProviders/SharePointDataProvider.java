...
import jio.System.Collections.ObjectModel.*;public class SharePointDataProvider implements IDataProvider,ISupportsLogger {protected NObject javonetHandle; /**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.lang.Integer getConnectionTimeout (){ try { return javonetHandle.get("ConnectionTimeout");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return 0;} }public SharePointDataProvider (java.lang.String url){ try {  javonetHandle = Javonet.New("SharePointDataProvider",url);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public SharePointDataProvider (java.lang.String url,java.lang.String username,java.lang.String password,java.lang.String domain){ try {  javonetHandle = Javonet.New("SharePointDataProvider",url,username,password,domain);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public SharePointDataProvider(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
