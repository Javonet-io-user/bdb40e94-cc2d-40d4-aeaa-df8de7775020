...
import Irony.Ast.*;
import Irony.Parsing.*;public class FromNode extends SqlNodeBase implements IAstNodeInit {protected NObject javonetHandle; public FromNode (){  super((NObject) null); try {  javonetHandle = Javonet.New("FromNode"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public FromNode(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
