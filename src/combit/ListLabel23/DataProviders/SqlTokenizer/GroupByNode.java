...
import Irony.Ast.*;
import Irony.Parsing.*;public class GroupByNode extends SqlNodeBase implements IAstNodeInit {protected NObject javonetHandle; public GroupByNode (){  super((NObject) null); try {  javonetHandle = Javonet.New("GroupByNode"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public GroupByNode(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
