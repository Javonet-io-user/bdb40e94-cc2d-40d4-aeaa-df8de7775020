...
import Irony.Ast.*;
import Irony.Parsing.*;public class OrderByNode extends SqlNodeBase implements IAstNodeInit {protected NObject javonetHandle; public OrderByNode (){  super((NObject) null); try {  javonetHandle = Javonet.New("OrderByNode"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public OrderByNode(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
