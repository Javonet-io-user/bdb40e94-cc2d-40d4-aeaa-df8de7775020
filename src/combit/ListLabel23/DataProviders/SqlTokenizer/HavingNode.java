...
import Irony.Ast.*;
import Irony.Parsing.*;public class HavingNode extends SqlNodeBase implements IAstNodeInit {protected NObject javonetHandle; public HavingNode (){  super((NObject) null); try {  javonetHandle = Javonet.New("HavingNode"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public HavingNode(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
