...
import Irony.Ast.*;
import Irony.Parsing.*;public class DummyNode implements IAstNodeInit {protected NObject javonetHandle; public DummyNode (){ try {  javonetHandle = Javonet.New("DummyNode");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public DummyNode(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
