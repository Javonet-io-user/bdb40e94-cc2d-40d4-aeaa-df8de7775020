...
import jio.System.CodeDom.*;public abstract class DomCollectionBase extends CollectionBase {protected NObject javonetHandle; public DomCollectionBase(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
                    this.javonetHandle = handle;
                }/**
	 * Method
	 */
            public DomItem GetItem (java.lang.Integer index){ try { return new DomItem((NObject)javonetHandle.invoke("GetItem",index));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * Method
	 */
	 ...
	 * Method
	 */
            public void Remove (DomItem item){ try { javonetHandle.invoke("Remove",item);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }/**
	 * Method
	 */
	 ...
	 * Method
	 */
            public void ImportFrom (DomCollectionBase source){ try { javonetHandle.invoke("ImportFrom",source);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }	static {
		try {
