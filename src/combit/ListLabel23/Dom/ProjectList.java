...
import combit.ListLabel23.*;public class ProjectList extends ProjectBase {protected NObject javonetHandle; public ProjectList (ListLabel parentComponent){  super((NObject) null); try {  javonetHandle = Javonet.New("ProjectList",parentComponent); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ProjectList(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
