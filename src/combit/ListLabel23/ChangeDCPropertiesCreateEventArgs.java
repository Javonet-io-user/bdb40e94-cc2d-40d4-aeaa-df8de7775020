...
import combit.ListLabel23.*;public class ChangeDCPropertiesCreateEventArgs extends EventArgs {protected NObject javonetHandle; /**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.lang.Integer getHandle (){ try { return javonetHandle.<NObject>get("Handle");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public ChangeDCPropertiesCreateEventArgs (LlPrinter callbackData){  super((NObject) null); try {  javonetHandle = Javonet.New("ChangeDCPropertiesCreateEventArgs",callbackData); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ChangeDCPropertiesCreateEventArgs(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
