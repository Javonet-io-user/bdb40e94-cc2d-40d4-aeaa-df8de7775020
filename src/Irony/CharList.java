...
import Irony.*;
import jio.System.*;public class CharList extends List<java.lang.Character> {public NObject javonetHandle; public CharList (){  super((NObject) null); try {  javonetHandle = Javonet.New("CharList"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public CharList(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
