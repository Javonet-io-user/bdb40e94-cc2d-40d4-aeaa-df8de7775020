...
import Irony.Parsing.*;public class AstExtensions {protected NObject javonetHandle; public void setJavonetHandle(NObject handle) {
                    this.javonetHandle = handle;
                }/**
	 * Method
	 */
            public static ParseTreeNodeList GetMappedChildNodes (ParseTreeNode node){ try { return new ParseTreeNodeList((NObject)Javonet.getType("AstExtensions").invoke("GetMappedChildNodes",node));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }	static {
		try {
