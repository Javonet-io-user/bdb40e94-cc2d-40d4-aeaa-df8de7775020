...
import jio.System.Collections.Generic.*;public class BnfTermList extends List<BnfTerm> {public NObject javonetHandle; public BnfTermList (){  super((NObject) null); try {  javonetHandle = Javonet.New("BnfTermList"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public BnfTermList(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
