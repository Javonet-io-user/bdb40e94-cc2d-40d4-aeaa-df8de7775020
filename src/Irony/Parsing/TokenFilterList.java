...
import jio.System.Collections.Generic.*;public class TokenFilterList extends List<TokenFilter> {public NObject javonetHandle; public TokenFilterList (){  super((NObject) null); try {  javonetHandle = Javonet.New("TokenFilterList"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public TokenFilterList(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
