...
import jio.System.*;public class ParserStateHash extends Dictionary<java.lang.String,ParserState> {public NObject javonetHandle; public ParserStateHash (){  super((NObject) null); try {  javonetHandle = Javonet.New("ParserStateHash"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ParserStateHash(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
