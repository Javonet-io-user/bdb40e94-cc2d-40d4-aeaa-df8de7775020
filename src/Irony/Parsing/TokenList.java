...
import jio.System.Collections.Generic.*;public class TokenList extends List<Token> {public NObject javonetHandle; public TokenList (){  super((NObject) null); try {  javonetHandle = Javonet.New("TokenList"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public TokenList(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
