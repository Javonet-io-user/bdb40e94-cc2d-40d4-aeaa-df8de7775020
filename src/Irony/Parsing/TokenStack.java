...
import jio.System.Collections.Generic.*;public class TokenStack extends Stack<Token> {public NObject javonetHandle; public TokenStack (){  super((NObject) null); try {  javonetHandle = Javonet.New("TokenStack"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public TokenStack(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
