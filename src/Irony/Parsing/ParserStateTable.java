...
import jio.System.Collections.Generic.*;public class ParserStateTable extends Dictionary<NonTerminal,ParserState> {public NObject javonetHandle; public ParserStateTable (){  super((NObject) null); try {  javonetHandle = Javonet.New("ParserStateTable"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ParserStateTable(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
