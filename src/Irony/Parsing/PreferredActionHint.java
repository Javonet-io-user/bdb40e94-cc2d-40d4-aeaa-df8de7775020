...
import Irony.Parsing.Construction.*;public class PreferredActionHint extends GrammarHint {protected NObject javonetHandle; public PreferredActionHint (PreferredActionType actionType){  super((NObject) null); try {  javonetHandle = Javonet.New("PreferredActionHint",NEnum.fromJavaEnum(actionType)); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public PreferredActionHint(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
