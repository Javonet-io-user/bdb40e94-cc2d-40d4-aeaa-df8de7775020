...
import jio.System.*;public class EscapeTable extends Dictionary<java.lang.Character,java.lang.Character> {public NObject javonetHandle; public EscapeTable (){  super((NObject) null); try {  javonetHandle = Javonet.New("EscapeTable"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public EscapeTable(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
