...
import Irony.Parsing.Construction.*;public abstract class GrammarHint extends BnfTerm {protected NObject javonetHandle; public GrammarHint (){  super((NObject) null); try {  javonetHandle = Javonet.New("GrammarHint"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public GrammarHint(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
