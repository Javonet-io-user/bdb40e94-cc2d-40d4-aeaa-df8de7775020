...
import jio.System.*;
import jio.System.Collections.Generic.*;public class ConstantTerminal extends Terminal {protected NObject javonetHandle; /**
	 * GetFiled
	 */
            public ConstantsTable getConstants (){ try { return new ConstantsTable((NObject)javonetHandle.<NObject>get("Constants"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetFiled
	 */
            public void setConstants (ConstantsTable param){ try { javonetHandle.set("Constants",param);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ConstantTerminal (java.lang.String name,Class nodeType){  super((NObject) null); try {  javonetHandle = Javonet.New("ConstantTerminal",name,Javonet.getType(getReturnObjectName(nodeType).getTypeName())); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ConstantTerminal(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
                    this.javonetHandle = handle;
                }/**
	 * Method
	 */
            public void Add (java.lang.String lexeme,NObject value){ try { javonetHandle.invoke("Add",lexeme,value);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }/**
	 * Method
	 */
