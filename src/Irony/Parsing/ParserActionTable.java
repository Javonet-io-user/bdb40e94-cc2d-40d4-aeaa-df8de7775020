...
import jio.System.Collections.Generic.*;public class ParserActionTable extends Dictionary<BnfTerm,ParserAction> {public NObject javonetHandle; public ParserActionTable (){  super((NObject) null); try {  javonetHandle = Javonet.New("ParserActionTable"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ParserActionTable(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
