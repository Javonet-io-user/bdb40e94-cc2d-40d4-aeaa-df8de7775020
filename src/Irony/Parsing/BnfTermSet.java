...
import jio.System.Collections.Generic.*;public class BnfTermSet extends HashSet<BnfTerm> {public NObject javonetHandle; public BnfTermSet (){  super((NObject) null); try {  javonetHandle = Javonet.New("BnfTermSet"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public BnfTermSet(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
