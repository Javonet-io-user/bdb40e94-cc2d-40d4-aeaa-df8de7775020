...
import jio.System.Collections.Generic.*;public class ParserTrace extends List<ParserTraceEntry> {public NObject javonetHandle; public ParserTrace (){  super((NObject) null); try {  javonetHandle = Javonet.New("ParserTrace"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ParserTrace(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
