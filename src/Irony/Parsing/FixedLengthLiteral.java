...
import jio.System.*;public class FixedLengthLiteral extends DataLiteralBase {protected NObject javonetHandle; /**
	 * GetFiled
	 */
	 ...
	 * SetFiled
	 */
            public void setLength (java.lang.Integer param){ try { javonetHandle.set("Length",param);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public FixedLengthLiteral (java.lang.String name,java.lang.Integer length,TypeCode dataType){  super((NObject) null); try {  javonetHandle = Javonet.New("FixedLengthLiteral",name,length,NEnum.fromJavaEnum(dataType)); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public FixedLengthLiteral(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
