...
import jio.System.Collections.Generic.*;public class NewLineTerminal extends Terminal {protected NObject javonetHandle; /**
	 * GetFiled
	 */
	 ...
	 * SetFiled
	 */
            public void setLineTerminators (java.lang.String param){ try { javonetHandle.set("LineTerminators",param);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public NewLineTerminal (java.lang.String name){  super((NObject) null); try {  javonetHandle = Javonet.New("NewLineTerminal",name); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public NewLineTerminal(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
