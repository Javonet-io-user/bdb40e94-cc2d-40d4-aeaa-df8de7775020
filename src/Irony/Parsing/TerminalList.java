...
import jio.System.Collections.Generic.*;public class TerminalList extends List<Terminal> {protected NObject javonetHandle; public TerminalList (){  super((NObject) null); try {  javonetHandle = Javonet.New("TerminalList"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public TerminalList(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
