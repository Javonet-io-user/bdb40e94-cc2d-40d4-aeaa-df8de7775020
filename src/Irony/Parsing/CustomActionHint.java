...
import Irony.Parsing.Construction.*;public class CustomActionHint extends GrammarHint {protected NObject javonetHandle; public CustomActionHint (ExecuteActionMethod executeMethod,PreviewActionMethod previewMethod){  super((NObject) null); try {  javonetHandle = Javonet.New("CustomActionHint",executeMethod,previewMethod); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public CustomActionHint(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
