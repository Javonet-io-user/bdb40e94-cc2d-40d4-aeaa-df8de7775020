...
import jio.System.Collections.Generic.*;public class KeyTermList extends List<KeyTerm> {public NObject javonetHandle; public KeyTermList (){  super((NObject) null); try {  javonetHandle = Javonet.New("KeyTermList"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public KeyTermList(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
