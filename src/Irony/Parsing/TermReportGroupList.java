...
import jio.System.Collections.Generic.*;public class TermReportGroupList extends List<TermReportGroup> {public NObject javonetHandle; public TermReportGroupList (){  super((NObject) null); try {  javonetHandle = Javonet.New("TermReportGroupList"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public TermReportGroupList(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
