...
import jio.System.Collections.Generic.*;public class ProductionList extends List<Production> {public NObject javonetHandle; public ProductionList (){  super((NObject) null); try {  javonetHandle = Javonet.New("ProductionList"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ProductionList(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
