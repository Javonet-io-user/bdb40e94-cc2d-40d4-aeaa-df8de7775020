...
import jio.System.Collections.Generic.*;public class TerminalSet extends HashSet<Terminal> {protected NObject javonetHandle; public TerminalSet (){  super((NObject) null); try {  javonetHandle = Javonet.New("TerminalSet"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public TerminalSet(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
