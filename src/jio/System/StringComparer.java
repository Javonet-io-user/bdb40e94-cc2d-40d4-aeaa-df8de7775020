...
import jio.System.*;public abstract class StringComparer implements IComparer,IEqualityComparer {protected NObject javonetHandle; public StringComparer(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
