...
import jio.System.*;public class ListSortDescriptionCollection implements IList,ICollection,IEnumerable {protected NObject javonetHandle; public ListSortDescriptionCollection (){ try {  javonetHandle = Javonet.New("ListSortDescriptionCollection");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ListSortDescriptionCollection (ListSortDescription[] sorts){ try {  javonetHandle = Javonet.New("ListSortDescriptionCollection",new Object[] {sorts});} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ListSortDescriptionCollection(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
