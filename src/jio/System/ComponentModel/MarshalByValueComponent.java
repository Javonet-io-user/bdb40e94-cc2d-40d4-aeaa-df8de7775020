...
import jio.System.*;public class MarshalByValueComponent implements IComponent,IDisposable,IServiceProvider {protected NObject javonetHandle; public MarshalByValueComponent (){ try {  javonetHandle = Javonet.New("MarshalByValueComponent");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public MarshalByValueComponent(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
