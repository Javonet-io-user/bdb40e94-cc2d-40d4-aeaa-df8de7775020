...
import jio.System.Net.*;public class WebClient extends Component {public NObject javonetHandle; public WebClient (){  super((NObject) null); try {  javonetHandle = Javonet.New("WebClient"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public WebClient(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
