...
import jio.System.Collections.*;public abstract class NameObjectCollectionBase implements ICollection,IEnumerable,ISerializable,IDeserializationCallback {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public KeysCollection getKeys (){ try { return new KeysCollection((NObject)javonetHandle.<NObject>get("Keys"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public NameObjectCollectionBase(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
