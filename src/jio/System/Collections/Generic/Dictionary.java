...
import jio.System.Collections.*;public class Dictionary<TKey,TValue> implements jio.System.Collections.IEnumerable,jio.System.Collections.IDictionary,jio.System.Collections.ICollection,ISerializable,IDeserializationCallback {protected NObject javonetHandle; /**
	 * GetProperty
	 */
            public jio.System.Collections.Generic.IEqualityComparer<TKey> getComparer (){ try { return ConvertToConcreteInterfaceImplementation((NObject) javonetHandle.<NObject>get("Comparer"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public ValueCollection<TKey,TValue> getValues (){ try { return new ValueCollection<TKey,TValue>((NObject)javonetHandle.<NObject>get("Values"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
